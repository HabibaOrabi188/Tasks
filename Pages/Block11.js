...
const Block11 = () => {
  ...
  const [name, setName] = useState('iPad Air Gen 5th Wi-Fi');
              ...
              <ScrollView>
                <StyledView className="flex h-full mb-4">
                  ...
                  <StyledInput
                    className={
                      descriptionBnt
                        ? 'border-2 border-blue-500 px-3 mt-1 rounded-xl bg-gray-200 '
                        : 'border border-gray-300 px-3 mt-1 rounded-xl bg-gray-200 '
                    }
                  ...
                  <StyledView className="flex flex-row space-x-5">
                    <StyledButton
                      ...
                      className={
                        submit
                          ? 'flex py-2 px-1 x-outo justify-center items-center self-center bg-blue-500 rounded-lg  items-center mt-2 border-2 border-blue-200'
                          : 'flex py-2 px-1 x-outo justify-center items-center self-center bg-blue-500 rounded-lg  items-center mt-2 '
                      }>
                    ...
                    <StyledButton
                      ...
                      className={
                        cancel == 0
                          ? 'flex flex-row py-1 px-2 justify-center items-center self-center border border-red-500 rounded-lg  items-center mt-2 '
                          : 'flex flex-row py-1 px-2 justify-center items-center self-center border-4 border-red-300 rounded-lg  items-center mt-2 '
                      }>
                      <Fontisto name="trash" color="#ef4444" size={16} />

                      <StyledText className="text-red-600 text-base font-medium ml-3 mt-1 ">
                        Delet
                      </StyledText>
                    </StyledButton>
                  </StyledView>
